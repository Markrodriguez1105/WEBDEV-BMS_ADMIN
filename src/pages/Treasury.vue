  ...
  <div>
          ...
          <div class="text-center mt-4" v-if="selectedItem">
            <div>
              <v-row justify="center">
                ...
                <v-btn icon @click.stop="deleteItem(selectedItem)" style="border-radius: 0; background-color:  #f44336; color:white;" class="rounded mx-4 margin-top: 10px">
    ...
    <v-dialog v-model="showDialog" max-width="600px">
      <v-card style="max-width: 600px; margin: 20px auto; padding: 20px;">
        <div>
          <h2 style="text-align: center; font-size: 20px; margin-bottom: 20px; background-color: #3a53a5; color: white; padding: 10px;">Cedula</h2>
        </div>
              ...
              <v-row>
                ...
                <v-col cols="6">
                  <v-select
                    ...
                    :items="['Single', 'Married','Widdowed', 'Divorced']"
                    label="Civil Status"
...
::-webkit-scrollbar-thumb {
  background-color: #677fcb; /* Color of the thumb (handle) */
