<template>
  ...
  <v-card class="elevation-2 header">
    <!-- Header Content -->
    <v-card-text>
      <h1 class="text-h4">New Member</h1>
    </v-card-text>
  </v-card>
    ...
    <v-col cols="1" md="12">
      ...
      <v-card class="general-census-form">
        ...
        <div class="confirmation">
          <input type="checkbox" id="confirmationCheckbox" v-model="confirmation">
        <br>
          <label for="confirmationCheckbox"> I confirm that this information is accurate and verified.</label>
        </div>
...
.header {
  background-color: #3aa553;
  color: white;
  box-shadow: 0px 0px 5px #c5c8d1e5;
