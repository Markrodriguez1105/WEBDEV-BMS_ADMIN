<template>
  ...
  <v-card class="elevation-2 header">
    <!-- Header Content -->
    <v-card-text>
      <h1 class="text-h4">New Household</h1>
    </v-card-text>
  </v-card>
      ...
      <v-card class="general-census-form">
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <label for="nursingMotherStatus">Nursing Mother Status</label>
            </td>
            <td>
              <input
                type="text"
                id="nursingMotherStatus"
                v-model="nursingMotherStatus"
                class="form-control"
              />
            </td>
            <td>
              <label for="familyPlanning">Practice of Family Planning</label>
            </td>
            <td>
              <input
                type="text"
                id="familyPlanning"
                v-model="familyPlanning"
                class="form-control"
              />
            </td>
          ...
          <tr>
            ...
            <td colspan="3">
              <input
                type="text"
                id="mainSourceOfWater"
                v-model="mainSourceOfWater"
                class="form-control"
              />
            </td>
          ...
          <tr>
            ...
            <td colspan="3">
              <input
                type="text"
                id="toiletFacility"
                v-model="toiletFacility"
                class="form-control"
              />
            </td>

            <td>
              <label for="tenureStatus">Tenure Status of Housing Unit</label>
            </td>
            <td colspan="3">
              <input
                type="text"
                id="tenureStatus"
                v-model="tenureStatus"
                class="form-control"
              />
            </td>
          </tr>
          <tr>
            <td>
              <label for="presenceOfGarden"
                >Presence of Vegetable Garden, Poultry Livestock, and
                Fishpond</label
              >
            </td>
            <td colspan="3">
              <input
                type="text"
                id="presenceOfGarden"
                v-model="presenceOfGarden"
                class="form-control"
              />
            </td>

            <td>
              <label for="accessToElectricity">Access to Electricity</label>
            </td>
            <td colspan="3">
              <input
                type="text"
                id="accessToElectricity"
                v-model="accessToElectricity"
                class="form-control"
              />
            </td>
          </tr>
          <tr>
            <td>
              <label for="constructionMaterials"
                >Construction Materials Used in the House</label
              >
            </td>
            <td colspan="2">
              <input
                ...
                v-model="constructionMaterials"
                class="form-control"
              />
            </td>
            <td>
              <label for="meansOfCommunication">Means of Communication</label>
            </td>
            <td colspan="2">
              <input
                type="text"
                id="meansOfCommunication"
                v-model="meansOfCommunication"
                class="form-control"
              />
            </td>
            <td>
              <label for="ofwStatus"
                >Overseas Filipino Worker (OFW) Status</label
              >
            </td>
            <td colspan="2">
              <input
          ...
          <tr>
            <td>
              <label for="povertyIncidence"
                >Poverty Incidence (Monthly Family Income)</label
              >
            </td>
            <td colspan="2">
              <input
        ...
        <div class="confirmation">
          ...
          <label for="confirmationCheckbox">
            I confirm that this information is accurate and verified.</label
          >
        </div>
...
export default {
  ...
  pregnancyStatus: '',
  nursingMotherStatus: '',
  familyPlanningPractice: '',
  presenceOfDisabilities: '',
  // Household Amenities and Infrastructure Fields
  mainWaterSource: '',
  garbageDisposal: '',
  toiletFacility: '',
  tenureStatus: '',
  vegetableGardenPresence: false,
  poultryLivestockPresence: false,
  fishpondPresence: false,
  ...
  methods: {
    submitForm() {
      if (this.confirmation) {
        ...
        alert("Please confirm that the information is accurate and verified.");
      }
    },
    generateYears() {
