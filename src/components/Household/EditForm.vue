<template>
  ...
  <v-card class="elevation-2 header">
    <!-- Header Content -->
    <v-card-text>
      <h1 class="text-h4">Edit Information</h1>
    </v-card-text>
  </v-card>
  ...
  <v-row>
    <v-col cols="1" md="12">
      ...
      <v-card class="general-census-form">
        ...
        <br>
          <label for="confirmationCheckbox"> I confirm that any edits made will be recorded to archive.</label>
        </div>
  ...
  methods: {
    submitForm() {
      if (this.confirmation) {
        ...
        alert('Please confirm that any edits made will be recorded to archive.');
      }
    },
    generateYears() {
